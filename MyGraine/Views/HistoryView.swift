...
struct HistoryView: View {
    ...
    ,   "Hunger or dehydration: People with migraines should avoid skipping meals. Research consistently shows that skipping meals is frequently linked to the onset of migraine.It’s linked to falling blood glucose levels. Dehydration is also a possible migraine trigger. Failure to drink enough water has been linked to the onset of headache. A small survey of people with migraines revealed that “insufficient fluid intake” was linked to headache onset in about 40 percent of responders. HOW TO FIX: make sure you are keeping up with a daily average of 3 meals a day and sufficient amounts of water. If you are exercsing, or have completed a physical workout, make sure you increase your food and fluid intake."
